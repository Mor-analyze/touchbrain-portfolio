...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('postgresql://postgres:Mory09124103725@db.lrngcvzjxjyqpwsemucn.supabase.co:5432/postgres', '').replace('postgres://', 'postgresql://')
