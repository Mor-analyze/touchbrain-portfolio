...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('postgresql://postgres.lrngcvzjxjyqpwsemucn:Mory09124103725@aws-1-ca-central-1.pooler.supabase.com:5432/postgres', '').replace('postgres://', 'postgresql://')
